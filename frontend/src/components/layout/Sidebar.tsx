...
import { FileText, BarChart3, Target, LogOut, Shield, Grid, CheckCircle2, Briefcase } from "lucide-react";
...
export const Sidebar = () => {
  ...
  return (
    <div className="w-[260px] h-full bg-[#1a56db] text-white flex flex-col relative overflow-hidden">
